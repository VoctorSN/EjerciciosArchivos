...
public class Ej4 {
    ...
    private static String contarNotas(List<String> notas) {
        ...
        return  new StringBuilder().append("Hay ").append(Collections.frequency(notas, Ej4_Corrector.EXCELENTE)).append(" excelentes\n")
                .append("Hay ").append(Collections.frequency(notas, Ej4_Corrector.NOTABLE)).append(" notables\n")
                .append("Hay ").append(Collections.frequency(notas, Ej4_Corrector.BIEN)).append(" bienes\n")
                .append("Hay ").append(Collections.frequency(notas, Ej4_Corrector.APROBADO)).append(" aprobados\n")
                .append("Hay ").append(Collections.frequency(notas, Ej4_Corrector.SUSPENSO)).append(" suspensos\n").toString();
    }
